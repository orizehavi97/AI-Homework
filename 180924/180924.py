...
while count < 10:
    ...
    print(
        f"Positive numbers: {count_pos}, negative numbers: {count_neg}, number of zeroes: {count_zero}, divideable by 7: {count_seven}, last positive: {temp_pos}, last negative: {temp_neg}")
